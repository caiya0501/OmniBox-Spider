// @name TV-旺旺+盘搜网盘融合完整版（线路优化版多源显示修复）
// @author
// @description 网盘线路按文件大小降序，名称含清晰度+大小，官方线路后置
// @description TV-旺旺接口展示影视分类/首页/搜索，详情自动匹配网盘资源，官方播放+网盘播放双源共存，无网盘自动兜底原链接
// @version 0.0.1
// @downloadURL https://raw.githubusercontent.com/caiya0501/OmniBox-Spider/refs/heads/main/CY_%E5%BD%B1%E8%A7%86/CY_PS_TV-%E6%97%BA%E6%97%BA.js
...
const SITE_API = "https://api.wwzy.tv/api.php/provide/vod";
const BASE_DOMAIN = "https://api.wwzy.tv";
const PAGE_LIMIT = 20;
    ...
    try {
        ...
        if (PANSOU_API && videoName) {
            try {
                ...
                const allPanSources = [];
                for (let i = i = 0; i < panRes.length; i++) {
